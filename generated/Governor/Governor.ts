...
export class Governor extends ethereum.SmartContract {
  ...
  getProposal(_proposalId: Bytes): Governor__getProposalResultValue0Struct {
    let result = super.call(
      "getProposal",
      "getProposal(bytes32):((address,uint32,uint32,uint32,uint8,uint32,uint32,uint32,uint32,uint32,bool,bool,bool))",
      [ethereum.Value.fromFixedBytes(_proposalId)],
    );
  ...
  getProposalVotes(_account: Address, _timestamp: BigInt): BigInt {
    let result = super.call(
      "getProposalVotes",
      "getProposalVotes(address,uint256):(uint256)",
      [
  ...
  getQuorumVotes(_account: Address, _timestamp: BigInt): BigInt {
    let result = super.call(
      "getQuorumVotes",
      "getQuorumVotes(address,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(_account),
        ethereum.Value.fromUnsignedBigInt(_timestamp),
      ],
  ...
  hasValidSoulBoundToken(proposer: Address, _type: i32): boolean {
    let result = super.call(
      "hasValidSoulBoundToken",
      "hasValidSoulBoundToken(address,uint8):(bool)",
      [
  ...
  propose(
    ...
    let result = super.call(
      "propose",
      "propose(address[],uint256[],bytes[],string,uint8):(bytes32)",
      [
        ethereum.Value.fromAddressArray(_targets),
        ethereum.Value.fromUnsignedBigIntArray(_values),
        ethereum.Value.fromBytesArray(_calldatas),
  ...
  soulBoundToken(): Address {
    let result = super.call("soulBoundToken", "soulBoundToken():(address)", []);

    return result[0].toAddress();
  }

  try_soulBoundToken(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "soulBoundToken",
      "soulBoundToken():(address)",
      [],
